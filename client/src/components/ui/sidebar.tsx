  ...
  (
    ...
    return (
      ...
      >
        ...
        <div
          className={cn(
            'duration-200 fixed inset-y-0 z-20 hidden h-svh w-[var(--sidebar-width)] transition-[left,right,width] ease-linear md:flex',
            side === 'left'
    ...
    const button = (
      <Comp
        ...
        className={cn(
          ...
          'data-[variant=default]:bg-transparent data-[variant=default]:text-sidebar-foreground',
          'data-[variant=outline]:border data-[variant=outline]:border-sidebar-border data-[variant=outline]:hover:bg-sidebar-accent data-[variant=outline]:hover:text-sidebar-accent-foreground',
